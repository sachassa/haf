...
def _implplan_prompt() -> str:
    ...
    return (
        ...
        "  - delegation = 8필드(from=\"Advisor\"·to=\"Worker\"·task=해당 task 와 동일·input·"
        "output=산출 파일·done=해당 done 과 동일·context·constraints=\"워크스페이스 밖 파일 "
        "생성·수정 금지, 보호 경계(.claude/·install-manifest.md·specs/·framework/) 무수정\").\n\n"
