...
작성일: 2026-07-05
상태: v0.9 Draft (개정 — §8 트리 갱신 · v0.9 Adapter 경계 산출물 실측 반영). 직전 기준선: v0.8 Baseline (개정 — §8 트리 갱신 · framework/plugins/ 3문서·확장 바인딩 3문서 실측 반영 · CP2 Pass — 첫 판정 Pass · CP3 승인 · 사용자 승인 2026-07-06)
상위 규약: AGENT.md
근거 정본:
